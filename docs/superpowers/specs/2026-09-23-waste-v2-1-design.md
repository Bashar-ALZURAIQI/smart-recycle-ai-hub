...
An empty `real\_world\_v2\_1` directory is valid and must not break the build.
...
The implementation may reuse proven logic from `scripts/build\_waste\_v2.py`, but existing V2 code and generated V2 data must remain unchanged.
